...
export const OneKey = () => (
	<KeyWrapper>
		<div className="w-3 h-3 flex items-center justify-center">1</div>
	</KeyWrapper>
);

export const TwoKey = () => (
	<KeyWrapper>
		<div className="w-3 h-3 flex items-center justify-center">2</div>
	</KeyWrapper>
);

export const ThreeKey = () => (
	<KeyWrapper>
		<div className="w-3 h-3 flex items-center justify-center">3</div>
	</KeyWrapper>
);
